...
static PyObject *__pyx_n_s_feature_extraction;
...
static PyObject *__pyx_pf_4test_feature_extraction(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_4test_1feature_extraction(PyObject *__pyx_self, PyObject *__pyx_arg_image); /*proto*/
static PyMethodDef __pyx_mdef_4test_1feature_extraction = {"feature_extraction", (PyCFunction)__pyx_pw_4test_1feature_extraction, METH_O, 0};
static PyObject *__pyx_pw_4test_1feature_extraction(PyObject *__pyx_self, PyObject *__pyx_arg_image) {
  ...
  assert(__pyx_arg_image); {
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_int(__pyx_arg_image, PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("test.feature_extraction", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4test_feature_extraction(__pyx_self, __pyx_v_image);
...
static PyObject *__pyx_pf_4test_feature_extraction(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image) {
  int __pyx_v_height;
  int __pyx_v_width;
  int __pyx_v_y;
  int __pyx_v_x;
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_ascontiguousarray); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_image, 3, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 8, __pyx_L1_error)
 ...
 */
  __pyx_t_6 = (__pyx_v_image.shape[0]);
  __pyx_t_7 = (__pyx_v_image.shape[1]);
 ...
 */
      ...
      } else if (unlikely(__pyx_t_14 >= __pyx_v_image.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_image.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_image.shape[2];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_image.shape[2])) __pyx_t_17 = 2;
      ...
      } else if (unlikely(__pyx_t_18 >= __pyx_v_image.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_19 >= __pyx_v_image.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_20 < 0) {
        __pyx_t_20 += __pyx_v_image.shape[2];
        if (unlikely(__pyx_t_20 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_20 >= __pyx_v_image.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
        __PYX_ERR(0, 13, __pyx_L1_error)
      }
      *((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_18 * __pyx_v_image.strides[0]) ) + __pyx_t_19 * __pyx_v_image.strides[1]) ) + __pyx_t_20 * __pyx_v_image.strides[2]) )) = ((int)(((double)(*((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_14 * __pyx_v_image.strides[0]) ) + __pyx_t_15 * __pyx_v_image.strides[1]) ) + __pyx_t_16 * __pyx_v_image.strides[2]) )))) / 255.0));
 ...
 */
      ...
      } else if (unlikely(__pyx_t_21 >= __pyx_v_image.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_22 < 0) {
        __pyx_t_22 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_22 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_22 >= __pyx_v_image.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_v_image.shape[2];
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_23 >= __pyx_v_image.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
      ...
      __pyx_t_17 = -1;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_17 = 0;
      } else if (unlikely(__pyx_t_24 >= __pyx_v_image.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_image.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_26 < 0) {
        __pyx_t_26 += __pyx_v_image.shape[2];
        if (unlikely(__pyx_t_26 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_26 >= __pyx_v_image.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
        __PYX_ERR(0, 14, __pyx_L1_error)
      }
      *((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_24 * __pyx_v_image.strides[0]) ) + __pyx_t_25 * __pyx_v_image.strides[1]) ) + __pyx_t_26 * __pyx_v_image.strides[2]) )) = ((int)(((double)(*((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_21 * __pyx_v_image.strides[0]) ) + __pyx_t_22 * __pyx_v_image.strides[1]) ) + __pyx_t_23 * __pyx_v_image.strides[2]) )))) / 255.0));
 ...
 */
      ...
      } else if (unlikely(__pyx_t_27 >= __pyx_v_image.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_28 < 0) {
        __pyx_t_28 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_28 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_28 >= __pyx_v_image.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_29 < 0) {
        __pyx_t_29 += __pyx_v_image.shape[2];
        if (unlikely(__pyx_t_29 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_29 >= __pyx_v_image.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
      ...
      __pyx_t_17 = -1;
      if (__pyx_t_30 < 0) {
        __pyx_t_30 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_30 < 0)) __pyx_t_17 = 0;
      } else if (unlikely(__pyx_t_30 >= __pyx_v_image.shape[0])) __pyx_t_17 = 0;
      if (__pyx_t_31 < 0) {
        __pyx_t_31 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_31 < 0)) __pyx_t_17 = 1;
      } else if (unlikely(__pyx_t_31 >= __pyx_v_image.shape[1])) __pyx_t_17 = 1;
      if (__pyx_t_32 < 0) {
        __pyx_t_32 += __pyx_v_image.shape[2];
        if (unlikely(__pyx_t_32 < 0)) __pyx_t_17 = 2;
      } else if (unlikely(__pyx_t_32 >= __pyx_v_image.shape[2])) __pyx_t_17 = 2;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
        __PYX_ERR(0, 15, __pyx_L1_error)
      }
      *((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_30 * __pyx_v_image.strides[0]) ) + __pyx_t_31 * __pyx_v_image.strides[1]) ) + __pyx_t_32 * __pyx_v_image.strides[2]) )) = ((int)(((double)(*((int *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_27 * __pyx_v_image.strides[0]) ) + __pyx_t_28 * __pyx_v_image.strides[1]) ) + __pyx_t_29 * __pyx_v_image.strides[2]) )))) / 255.0));
    }
  }
 ...
 */
  ...
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_image, 3, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *     image = np.ascontiguousarray(image)
 */
  __pyx_tuple__19 = PyTuple_Pack(6, __pyx_n_s_image, __pyx_n_s_image, __pyx_n_s_height, __pyx_n_s_width, __pyx_n_s_y, __pyx_n_s_x); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(1, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_test_pyx, __pyx_n_s_feature_extraction, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     image = np.ascontiguousarray(image)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4test_1feature_extraction, NULL, __pyx_n_s_test); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_feature_extraction, __pyx_t_1) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
